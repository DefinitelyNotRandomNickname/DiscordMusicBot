# Dicord music and miscellaneous bot <h1 style="color:red;">(NSFW)</h1>
...
To play music you need to configure and start Lavalink, set up your java and `application.yml file` and start it with `java -jar Lavalink`. After it started you can
...
## Pics & gifs
This is <h1 style="color:red;">(NSFW)</h1> part, and sometimes has lags. They depend on API and reddit.
...
With `on_message` function you can set up bot responses to certain sentences, and there was also plan for doing laundry alarm that would go WEE WOO WEE WOO, but finally
